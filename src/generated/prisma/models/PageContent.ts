...
export type PageContentWhereInput = {
  ...
  content?: Prisma.JsonFilter<"PageContent">
...
export type PageContentScalarWhereWithAggregatesInput = {
  ...
  content?: Prisma.JsonWithAggregatesFilter<"PageContent">
...
export type PageContentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"page" | "content" | "updatedAt", ExtArgs["result"]["pageContent"]>
...
export interface PageContentDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const pageContentWithPageOnly = await prisma.pageContent.findMany({ select: { page: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many PageContents and only return the `page`
   * const pageContentWithPageOnly = await prisma.pageContent.createManyAndReturn({
   *   select: { page: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more PageContents and only return the `page`
   * const pageContentWithPageOnly = await prisma.pageContent.updateManyAndReturn({
   *   select: { page: true },
   *   where: {
   *     // ... provide filter here
   *   },
